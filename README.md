# go-face [![Build Status](https://travis-ci.org/modeck/go-face.svg?branch=master)](https://travis-ci.org/modeck/go-face) [![GoDoc](https://godoc.org/github.com/modeckrus/go-face?status.svg)](https://godoc.org/github.com/modeckrus/go-face)
...
from [go-face-testdata](https://github.com/modeckrus/go-face-testdata) repo:

```bash
wget https://github.com/modeckrus/go-face-testdata/raw/master/models/shape_predictor_5_face_landmarks.dat
wget https://github.com/modeckrus/go-face-testdata/raw/master/models/dlib_face_recognition_resnet_model_v1.dat
wget https://github.com/modeckrus/go-face-testdata/raw/master/models/mmod_human_face_detector.dat
```
...
```go
import "github.com/modeckrus/go-face"
```

To install go-face in your $GOPATH:

```bash
go get github.com/modeckrus/go-face
```

For further details see [GoDoc documentation](https://godoc.org/github.com/modeckrus/go-face).
...
// points to the <https://github.com/modeckrus/go-face-testdata> clone.
